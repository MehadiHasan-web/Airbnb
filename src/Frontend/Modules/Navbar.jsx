...
const Navbar = () => {
    return (
        <div className="border-b">
            {/* mobile to small section start */}
            <div className="w-full px-3 py-3 block md:hidden">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        <Link to={'/'}>
                            <svg
                                id="logo-46"
                                className="gradient w-14 h-8 sm:w-24 sm:h-12"
                                viewBox="0 0 123 61"
                                fill="none"
                            ...
                            >
                                ...
                                <defs>
                                    ...
                                    >
                                        {" "}
                                        <stop className="ccustom" stopColor="#FF557E" />{" "}
                                        <stop
                                            className="ccompli1"
                                            offset="0.841052"
                                            stopColor="#FF5555"
                                    ...
                                    >
                                        {" "}
                                        <stop className="ccompli1" stopColor="#58CCDC" />{" "}
                                        <stop
                                            className="ccompli1"
                                            offset={1}
                                            stopColor="#58CCDC"
                                    ...
                                    >
                                        {" "}
                                        <stop className="ccompli2" stopColor="#8263DB" />{" "}
                                        <stop offset="0.568731" stopColor="#8172DA" stopOpacity="0.26" />{" "}
                                        <stop
                                            className="ccompli2"
                                            offset={1}
                                            stopColor="#8172DA"
                                    ...
                                    >
                                        {" "}
                                        <stop className="ccompli1" stopColor="#41D1B7" />{" "}
                                        <stop
                                            className="ccompli1"
                                            offset="0.492704"
                                            stopColor="#41D1B7"
                                    ...
                                    >
                                        {" "}
                                        <stop className="ccompli2" stopColor="#FFEC45" />{" "}
                                        <stop
                                            className="ccompli2"
                                            offset="0.549191"
                                            stopColor="#FFEC45"
            ...
            {/* mobile to small section end */}
            {/* middle to desktop section start */}
            <div className="hidden md:flex md:justify-between md:items-center py-4 container mx-auto md:px-1 lg:px-2 gap-5">
                {/* logo  */}
                <div>
                    <Link to={'/'}>
                        <svg
                            id="logo-46"
                            className="gradient md:w-24 md:h-11 lg:w-28 lg:h-12"
                            viewBox="0 0 123 61"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                        >
